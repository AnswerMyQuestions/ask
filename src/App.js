      ...
      <div className={classes.root}>
        ...
        <AppBar position="static">
          <Toolbar className={classes.toolbar}>
            ...
            <Button variant="outlined" className={classes.login_btn} href="http://www.google.com/">
              로그인
            </Button>
          </Toolbar>
        </AppBar>
          ...
          <div className={classes.page_explaination}>
            ...
            <div>
              ...
              <Dialog open={this.state.open} onClose={this.handleClose}>
                ...
                <DialogActions>
                  <Button onClick={this.handleClose} className={classes.howtoclosing_btn}>닫기</Button>
                </DialogActions>
              </Dialog>
            </div>
          </div>
