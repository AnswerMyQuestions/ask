    ...
    <div className="root">
      ...
      <div className="body">
        <form class="chat_form">
          <TextField type="text" name="message" className="textField" label="질문을 입력하세요." value={message} onChange={handleValueChange} variant="outlined" onKeyPress={event => event.key === 'Enter' ? sendMessage(event) : null}></TextField>
